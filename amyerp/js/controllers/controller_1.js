...
//                        //console.log(ref_cex);
        ...
        .controller("CmdsEnCoursLivraisonController", function ($scope, PostFactory, $filter, $cookieStore, $cookies, $window, $location, $compile) {
            ...
            $scope.CmdsEnCoursLivraison = PostFactory.listCommandeEnattenteLivraisonEspaceclientPaginate(1, 30).then(function (commandeseEnattentelivraisonspaceclient) {
                ...
                $scope.pageCount = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount;
                $scope.CurrentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                $scope.currentPageAttLivraison = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                $("button#firstPageAttLivraison").hide();
                var currentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                var nbrMaxNextPages = 5;
                for (var i = currentPage + 1; i <= nbrMaxNextPages; i++) {
                    if (i < commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount) {
                        var $html = $compile("<button class='btn btn-default' ng-click='showPageAttLivraison(" + i + ")'>" + i + "</button>")($scope);
                        $("div#otherPagesAttLivraison").append($html);
                    }
                }
                if (commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.prevPage == false) {
                    $("#nextPageAttLivraison").attr('disabled', false);
                    $("#previousPageAttLivraison").attr('disabled', true);
                }
            },
                    function (msg) {
                        alert(msg);
            ...
            $scope.nextPageAttLivraison = function () {
                $("button#firstPageAttLivraison").show();
                var searchKey = $scope.searchAttLivraison;
                console.log($scope.CurrentPage);
                console.log($scope.pageCount);
                if ($scope.CurrentPage <= $scope.pageCount) {
                    $scope.CurrentPage = $scope.CurrentPage + 1;
                    $scope.CmdsEnCoursLivraison = PostFactory.listCommandeEnattenteLivraisonEspaceclientPaginate($scope.CurrentPage, 30, searchKey).then(function (commandeseEnattentelivraisonspaceclient) {
                        $scope.CmdsEnCoursLivraison = commandeseEnattentelivraisonspaceclient.data.commandesAttLivraison;
                        $scope.currentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                        $scope.currentPageAttLivraison = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                        var currentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                        var nbrMaxNextPages = 5 + commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                        $("div#otherPagesAttLivraison").html("");
                        for (var i = currentPage + 1; i <= nbrMaxNextPages; i++) {
                            if (i < commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount) {
                                var $html = $compile("<button class='btn btn-default' ng-click='showPageAttLivraison(" + i + ")'>" + i + "</button>")($scope);
                        ...
                        if (commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.nextPage == false) {
                            $("button#nextPageAttLivraison").attr('disabled', true);
                            $("button#previousPageAttLivraison").removeAttr('disabled');
                        } else {
                            $("button#nextPageAttLivraison").removeAttr('disabled');
                        }
                        if (commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.previousPage == false) {
                            $("button#previousPageAttLivraison").attr('disabled', true);
                        } else {
                            $("button#previousPageAttLivraison").removeAttr('disabled');
                        }
                    },
            ...
            $scope.previousPageAttLivraison = function () {
                var searchKey = $scope.searchAttLivraison;
            ...
            $scope.firstPageAttLivraison = function () {
                var searchKey = $scope.searchAttLivraison;
                $("div#otherPagesAttLivraison").html("");
                $scope.CmdsEnCoursLivraison = PostFactory.listCommandeEnattenteLivraisonEspaceclientPaginate(1, 30, searchKey).then(function (commandeseEnattentelivraisonspaceclient) {
                    $scope.CmdsEnCoursLivraison = commandeseEnattentelivraisonspaceclient.data.clients;
                    $scope.pageCount = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount;
                    $scope.currentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                    var currentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                    var nbrMaxNextPages = 5;
                    ...
                    if (commandeseEnattentelivraisonspaceclient.data.countPage.Commande.prevPage == false) {
                        $("button#nextPageAttLivraison").attr('disabled', false);
                        $("button#previousPageAttLivraison").attr('disabled', true);
                    }
                },
                        function (msg) {
            ...
            $scope.showPageAttLivraison = function (index) {
                console.log(index);
                var searchKey = $scope.searchAttLivraison;
                $scope.CmdsEnCoursLivraison = PostFactory.listCommandeEnattenteLivraisonEspaceclientPaginate(index, 30, searchKey).then(function (commandeseEnattentelivraisonspaceclient) {
                    $scope.CmdsEnCoursLivraison = commandeseEnattentelivraisonspaceclient.data.commandesAttLivraison;
                    ...
                    if (commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.prevPage == false) {
                        $("button#nextPageAttLivraison").attr('disabled', false);
                        $("button#previousPageAttLivraison").attr('disabled', true);
                        $("button#currentPageAttLivraison").hide();
                        $("button#firstPageAttLivraison").show();
                    }
                },
                        function (msg) {
            ...
            $scope.searchAttLivraisonFunc = function (searchAttLivraison) {
                ...
                if (searchKey.length >= 3) {
                    ...
                    $scope.CmdsEnCoursLivraison = PostFactory.listCommandeEnattenteLivraisonEspaceclientPaginate(1, 30, searchKey, ville).then(function (commandeseEnattentelivraisonspaceclient) {
                        $("div#otherPagesAttLivraison").html("");
                        $scope.CmdsEnCoursLivraison = commandeseEnattentelivraisonspaceclient.data.commandesAttLivraison;
                        $scope.pageCount = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount;
                        $scope.currentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                        var currentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                        var nbrMaxNextPages = 5 + commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount;
                        for (var i = currentPage + 1; i <= nbrMaxNextPages; i++) {
                            if (i < commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount) {
                                var $html = $compile("<button class='btn btn-default' ng-click='showPageAttLivraison(" + i + ")'>" + i + "</button>")($scope);
                                $("div#otherPagesAttLivraison").append($html);
                    ...
                    if (searchKey === "") {
                        ...
                        $scope.CmdsEnCoursLivraison = PostFactory.listCommandeEnattenteLivraisonEspaceclientPaginate(1, 30, searchKey).then(function (commandeseEnattentelivraisonspaceclient) {
                            ...
                            var nbrMaxNextPages = 5 + commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount;
                            for (var i = currentPage + 1; i <= nbrMaxNextPages; i++) {
                                if (i < commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount && i <= 5) {
                                    var $html = $compile("<button class='btn btn-default' ng-click='showPageAttLivraison(" + i + ")'>" + i + "</button>")($scope);
                                    $("div#otherPagesAttLivraison").append($html);
                                }
                            }
            ...
            $scope.update_en_attente_livraison = function () {
                ...
                $scope.CmdsEnCoursLivraison = PostFactory.listCommandeEnattenteLivraisonEspaceclientPaginate(1, 30).then(function (commandeseEnattentelivraisonspaceclient) {
                    $scope.CmdsEnCoursLivraison = commandeseEnattentelivraisonspaceclient.data.commandesAttLivraison;
                    $scope.countEnattentelivraison = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount;
                    $scope.pageCount = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.pageCount;
                    $scope.CurrentPage = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                    $scope.currentPageAttLivraison = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.page;
                    $("button#firstPageAttLivraison").hide();
...
//                    //console.log('data');
                ...
                // UPDATE SCOPE
                $scope.update_en_attente_livraison1 = function () {
                    $("div#otherPagesAttLivraison").html("");
                    $scope.CmdsEnCoursLivraison = PostFactory.listCommandeEnattenteLivraisonEspaceclientPaginate(1, 30).then(function (commandeseEnattentelivraisonspaceclient) {
                        $scope.CmdsEnCoursLivraison = commandeseEnattentelivraisonspaceclient.data.commandesAttLivraison;
                        $scope.countEnattentelivraison = commandeseEnattentelivraisonspaceclient.data.pageCount.Commande.count;
...
//                                                //console.log(vildeCommande);
                                            ...
                                            var retour = '';
//                                            if (commandeBarre.Commande.source == 'espace client') {
...
//                                            if (commandeBarre.Commande.state == 'Non Traitée') {
//                                                recuperateur = 'Déposée';
//                                            }
//                                            }
//                                            if (commandeBarre.Commande.source != 'espace client') {
...
//                                                var listCommande = [];
//                                                var commande_name = $("#CodeBarre").val();
//                                                $("#CommaneInStock tr").each(function (i, v) {
...
//                //console.log(Auth.user);
                ...
                $scope.nextPageRamassageDepot = function () {
                    $("button#firstPageRamassageDepot").show();
                    var searchKey = $scope.searchRamassageDepot;
                    console.log($scope.CurrentPage);
                    console.log($scope.pageCount);
                    if ($scope.CurrentPage <= $scope.pageCount) {
                        $scope.CurrentPage = $scope.CurrentPage + 1;
                        $scope.CmdsRamassageDepot = PostFactory.listClientRamassageDepotPaginate($scope.CurrentPage, 30, searchKey).then(function (clientsramassage) {
                            $scope.CmdsRamassageDepot = clientsramassage.data.commandesRamassageDepot;
                            $scope.currentPage = clientsramassage.data.pageCount.User.page;
                            $scope.currentPageRamassageDepot = clientsramassage.data.pageCount.User.page;
                            var currentPage = clientsramassage.data.pageCount.User.page;
                            var nbrMaxNextPages = 5 + clientsramassage.data.pageCount.User.page;
                            $("div#otherPagesRamassageDepot").html("");
                            for (var i = currentPage + 1; i <= nbrMaxNextPages; i++) {
                                if (i < clientsramassage.data.pageCount.User.pageCount) {
                                    var $html = $compile("<button class='btn btn-default' ng-click='showPageRamassageDepot(" + i + ")'>" + i + "</button>")($scope);
                            ...
                            if (clientsramassage.data.pageCount.User.nextPage == false) {
                                $("button#nextPageRamassageDepot").attr('disabled', true);
                                $("button#previousPageRamassageDepot").removeAttr('disabled');
                            } else {
                                $("button#nextPageRamassageDepot").removeAttr('disabled');
                            }
                            if (clientsramassage.data.pageCount.User.previousPage == false) {
                ...
                $scope.previousPageRamassageDepot = function () {
                    var searchKey = $scope.searchRamassageDepot;
                    if ($scope.CurrentPage > 1) {
                        $scope.CurrentPage = $scope.CurrentPage - 1;
                        $scope.CmdsRamassageDepot = PostFactory.listClientRamassageDepotPaginate($scope.CurrentPage, 30, searchKey).then(function (clientsramassage) {
                ...
                $scope.showPageRamassageDepot = function (index) {
                    var searchKey = $scope.searchRamassageDepot;
                    $scope.CmdsRamassageDepot = PostFactory.listClientRamassageDepotPaginate(index, 30, searchKey).then(function (clientsramassage) {
                        $scope.CmdsRamassageDepot = clientsramassage.data.commandesRamassageDepot;
                        ...
                        if (clientsramassage.data.pageCount.User.prevPage == false) {
                            $("button#nextPageRamassageDepot").attr('disabled', false);
                            $("button#previousPageRamassageDepot").attr('disabled', true);
                            $("button#currentPageRamassageDepot").hide();
                            $("button#firstPageRamassageDepot").show();
                        }
                    },
                            function (msg) {
...
//                    $cookieStore.put('products', 'salut');
//                    $cookieStore.put('products', JSON.stringify(products));
                    //                    $cookies.put('products', JSON.stringify(products));
                    //                    if ($cookieStore.get('products') || $cookies.get('products')) {
...
//                                                    <img src="http://api.colisexpress.tn/img/{{stock.url}}" class="thumbnail center-block img-responsive " />\n\
...
//                        data.dataCommande.push({name: $.trim($(value).attr('data-product'))});
                    ...
                    var item = $compile("<tr id='trProduct' data-product='" + product_name + "'><td>" + product + "</td><td><input type='number' id='Qte' placeholder='Qte' name=QteTelephone' class='form-control' style='width: 100px;' /></td><td><div id='deleteItem' ng-click='removeItem()'><i style='cursor: pointer; color: #34aadc;' class='fa fa-times fa-2x'></i></div></td></tr>")($scope);
...
//                    $('#Qte').val('');
                ...
                $scope.genererBonSortie = function ($event) {
                    ...
                    $('tr#trProduct').each(function (i, v) {
                        dataCommande.Bon.push({qte: $(v).children().eq(1).text(), content: $.trim($(v).attr('data-product'))});
                    });
                    console.log(dataCommande);
