...
var Layout = function () {
    ...
    var handleSidebarToggler = function () {
        ...
        $('body').on('click', '.sidebar-toggler', function (e) {
            ...
            if (body.hasClass("page-sidebar-closed")) {
                $("a.secondLogo").removeAttr("style").attr("style", "display:none;");
                body.removeClass("page-sidebar-closed");
                sidebarMenu.attr('style', 'margin-top: 10px;');
                sidebarMenu.removeClass("page-sidebar-menu-closed");
                if ($.cookie) {
                    $.cookie('sidebar_closed', '0');
                }
            } else {
                $("a.secondLogo").removeAttr("style");
                body.addClass("page-sidebar-closed");
                sidebarMenu.addClass("page-sidebar-menu-closed");
                sidebarMenu.attr('style', 'margin-top: 65px;');
                if (body.hasClass("page-sidebar-fixed")) {
                    sidebarMenu.trigger("mouseleave");
                }
//                $("#ScrolSidebarClosed").attr("style", "overflow-y: auto !important;");
//                $("#ScrolSidebarClosed").attr("style", "overflow-x: inherit !important;");
//                setInterval(function () {
//                    $("#ScrolSidebarClosed").attr("style", "overflow: auto !important;");
//                    console.log('sidebar');
//                }, 100);
                if ($.cookie) {
